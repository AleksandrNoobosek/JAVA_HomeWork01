...
public class Task5 {
    ...
    public static void main(String[] args) {
        ex5("G:\\учеба\\JAVA_Seminar\\program\\src\\main\\java\\lesson2");
    }
...
/*        PrintWriter pw = null;
        ...
        File output = new File("G:\\учеба\\JAVA_Seminar\\program");
        if (!output.exists()) {
            try {
    ...
    private static String[] convertPathToNamesArr(String path) throws DirectoryIsNotFoundException {
